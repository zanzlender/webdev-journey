...
export type GenerateActivationCodeEmailProps = {
  activationCode: string | number;
  email: string;
};

export function GenerateActivationCodeEmail({ activationCode }: GenerateActivationCodeEmailProps) {
  const html = `
      ...
      <tr>
        ...
        <td align="center" data-bgcolor="Body" bgcolor="#F4F4F4" data-composer>
          <table
            ...
            data-module="colibri-preheader-5"
          >
            <!-- colibri-preheader-5 -->
            <tr>
              <td align="center" bgcolor="#f9f6c7" data-bgcolor="BgColor">
                ...
                >
                      ...
                      >
                        <tr>
                          ...
                          >
                            ...
                            >
                              <tr
                                data-element="colibri-preheader-5-title"
                                data-label="Titles"
                              >
                                <td
                                  class="center-text"
                          ...
                          >
                            ...
                            >
                              <tr
                                data-element="colibri-preheader-5-webview"
                                data-label="Webview"
                              >
                  ...
                  <tr data-element="colibri-preheader-5-logo" data-label="Logo">
                    <td
                      height="30"
                    ...
                    <div>
                      ...
                      >
                        <tr>
                          <td
                            align="center"
                            background="images/header-5-back.png"
                            data-bg-image
          ...
          <table
            ...
            width="640"
            style="width: 640px; max-width: 640px"
            data-module="colibri-basic-message-5"
          >
            <!-- colibri-basic-message-5 -->
            <tr>
              <td align="center" bgcolor="#f9f6c7" data-bgcolor="BgColor">
                <!-- Content -->
                <table
                ...
                >
                  ...
                  <tr data-element="colibri-bm-headline" data-label="Headlines">
                    ...
                    >
                      <singleline>
                        <div mc:edit data-text-edit>Tvoj aktivacijski kod</div>
                      </singleline>
                    </td>
                  </tr>
                  <tr data-element="colibri-bm-headline" data-label="Headlines">
                    ...
                    >
                      <singleline>
                        <div mc:edit data-text-edit>
                          Čestitamo! Postao/la si član Tasky zajednice! Kako bi
                          registracija bila potpuna, potvrdi svoj račun pomoću
                          sljedećeg koda.
                        </div>
                      </singleline>
                    </td>
                  ...
                  <tr data-element="colibri-bm-usercode" data-label="User Code">
                    <td align="center">
                      <!-- Use Code -->
                      <table
                        border="0"
                      ...
                      >
                        <tr>
                          <td
                            ...
                            data-border-radius-custom="User Code"
                            data-bgcolor="User Code"
                            bgcolor="#fffef3"
                            style="
                              border-radius: 10px;
                              ...
                              <tr>
                                ...
                                >
                                  <singleline>
                                    <div mc:edit data-text-edit>
                                      KOD:
                                      <strong style="color: #e38529"
                                        >${activationCode}</strong
                                      >
                                    </div>
                                  </singleline>
                                </td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" align="center">
          <tr>
            ...
            <![endif]-->
                            <singleline>
                              <a
                                href="${process.env.HOST}/user/activate"
                                mc:edit
                                data-button
