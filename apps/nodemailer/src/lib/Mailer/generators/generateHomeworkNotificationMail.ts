/**
 * This function generate an email for notifying a student that he/she
 * has received a homework.
 */
...
export type GenerateHomeworkNotificationMailProps = {
  user: {
    first_name: string;
    last_name: string;
    email: string;
...
export function GenerateHomeworkNotificationMail({
  user,
  subject,
  startDate,
  closeDate,
}: GenerateHomeworkNotificationMailProps) {
  const html = `
...
<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;" data-module="colibri-preheader-7">
  <!-- colibri-preheader-7 -->
  <tr>
    <td align="center" bgcolor="#b0e2ca" data-bgcolor="BgColor">
...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
  <tr data-element="colibri-preheader-7-webview" data-label="Webview">
...
<!-- rwd-col -->
  ...
  <tr data-element="colibri-preheader-7-logo" data-label="Logo">
    <td height="30" style="font-size:30px;line-height:30px;" data-height="Spacing above logo">&nbsp;</td>
  </tr>
  <tr data-element="colibri-preheader-7-logo" data-label="Logo">
    <td align="center" class="center-text">
      <img style="width:120px;border:0px;display: inline!important;" src="cid:logo@tasky.study" width="120" border="0" editable="true" data-icon data-image-edit data-url data-label="Logo" data-image-width alt="logo">
    </td>
  </tr>
  <tr>
...
<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;" data-module="colibri-header-7">
  <!-- colibri-header-7 -->
  <tr>
    <td align="center" data-fallback-color="Fallback Color" bgcolor="#b0e2ca">

<v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:640px;">
<v:fill origin="0.5, 0.5" position="0.5, 0.5" src="cid:logo@tasky.study" type="tile" size="1,1" aspect="atleast"></v:fill>
<v:textbox style="mso-fit-shape-to-text:true;" inset="0,0,0,0">

<div>
<!-- colibri-header-7-bg-image -->

<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;" data-module="colibri-basic-message-7">
  <!-- colibri-basic-message-7 -->
  <tr>
    <td align="center" bgcolor="#b0e2ca" data-bgcolor="BgColor">
...
<table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="inner-table row container-padding" width="580" style="width:580px;max-width:580px;">
  ...
  <tr data-element="colibri-bm-subline" data-label="Sublines">
    <td class="center-text" data-text-style="Sublines" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:26px;margin-bottom:20px;line-height:36px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
        <singleline>
          <div mc:edit data-text-edit>
            Pozdrav, ${user.first_name + " " + user.last_name}
          </div>
        </singleline>
    </td>
  </tr>
  ...
  <tr data-element="colibri-bm-headline" data-label="Headlines">
    <td class="center-text" data-text-style="Headlines" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:38px;line-height:48px;font-weight:800;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
        <singleline>
          <div mc:edit data-text-edit>
            Dodijeljena ti je nova zadaća iz predmeta ${subject}
          </div>
        </singleline>
    </td>
  </tr>
  ...
  <tr data-element="colibri-bm-avatar-name" data-label="Avatar name">
    <td height="30" style="font-size:30px;line-height:30px;" data-height="Spacing under avatar">&nbsp;</td>
  </tr>
  <tr data-element="colibri-bm-paragraphs" data-label="Paragraphs">
    <td align="center">
      <!-- Paragraphs -->
      <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="row" width="480" style="width:480px;max-width:480px;">
        <tr>
          <td class="center-text" data-text-style="Paragraphs" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:italic;color:#111111;text-decoration:none;letter-spacing:0px;">
              <singleline>
                <div mc:edit data-text-edit>
                  Dodijeljena ti je nova zadaća iz ${subject} koja se otvara ${startDate.toLocaleDateString()}-${startDate.toLocaleTimeString()}, te se zatvara ${closeDate.toLocaleDateString()}-${closeDate.toLocaleTimeString()}
                </div>
              </singleline>
          </td>
        </tr>
          ...
          <tr>
            ...
            <![endif]-->
              <singleline>
                <a href="${
                  process.env.HOST
                }/students/homework/" mc:edit data-button data-text-style="Buttons" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 15px 35px 15px 35px;display: inline-block;"><span>Idi na zadaću</span></a>
              </singleline>
            <!--[if (gte mso 9)|(IE)]>
            </td>
            <td align="center" width="35"></td>
