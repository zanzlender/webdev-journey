...
function createTokenForPasswordReset(email: string) {
  const token = email;
  return "SUPER_SECRET=" + token + "=NO_ONE_WILL_KNOW";
}
...
export type GeneratePasswordResetEmailProps = {
  email: string;
  userId: string;
};

export function GeneratePasswordResetEmail({ email, userId }: GeneratePasswordResetEmailProps) {
  const token = createTokenForPasswordReset(email);
      ...
      <tr>
        ...
        <td align="center" data-bgcolor="Body" bgcolor="#F4F4F4" data-composer>
          <table
            ...
            data-module="colibri-preheader-4"
          >
            <!-- colibri-preheader-4 -->
            <tr>
              <td align="center" bgcolor="#f9f6c7" data-bgcolor="BgColor">
                <!-- Content -->
                <table
                  data-inner-table
                  border="0"
                ...
                >
                      ...
                      >
                        <tr>
                          ...
                          >
                            ...
                            >
                              <tr
                                data-element="colibri-preheader-4-title"
                                data-label="Titles"
                              >
                                <td
                                  class="center-text"
                          ...
                          <td
                            ...
                            width="6.66%"
                            height="20"
                            style="width: 6.66%; max-width: 6.66%; height: 20px"
                          >
                            &nbsp;
                          </td>
                          <td
                          ...
                          >
                            ...
                            >
                              <tr
                                data-element="colibri-preheader-4-webview"
                                data-label="Webview"
                              >
                  ...
                  <tr data-element="colibri-preheader-4-logo" data-label="Logo">
                    <td
                      height="30"
                    ...
                    <div>
                      ...
                      >
                        <tr>
                          <td
                            align="center"
                            background="images/header-4-back.png"
                            data-bg-image
          ...
          <table
            ...
            width="640"
            style="width: 640px; max-width: 640px"
            data-module="colibri-basic-message-4"
          >
            <!-- colibri-basic-message-4 -->
            <tr>
              <td align="center" bgcolor="#f9f6c7" data-bgcolor="BgColor">
                <!-- Content -->
                <table
                ...
                >
                  ...
                  <tr data-element="colibri-headline" data-label="Headlines">
                    <td
                      class="center-text"
                    ...
                    >
                      <singleline>
                        <div mc:edit data-text-edit>Zaboravljena lozinka</div>
                      </singleline>
                    </td>
                  </tr>
                  <tr data-element="colibri-headline" data-label="Headlines">
                  ...
                  <tr data-element="colibri-paragraph" data-label="Paragraphs">
                    <td
                      class="center-text"
                    ...
                    >
                      <singleline>
                        <div mc:edit data-text-edit>
                          Zaboravio/la si svoju lozinku? Nema problema!
                        </div>
                        <div mc:edit data-text-edit>
                          Klikni na gumb ispod i odvesti će te do stranice gdje
                          možeš kreirati novu lozinku :)
                        </div>
                      </singleline>
                    </td>
                  </tr>
                  <tr
                    data-element="colibri-header-paragraph"
        ...
        <table border="0" cellpadding="0" cellspacing="0" align="center">
          <tr>
            ...
            <![endif]-->
                            <singleline>
                              <a
                                href="${process.env.HOST}/user/${userId}/newPassword/${token}"
                                mc:edit
                                data-button
