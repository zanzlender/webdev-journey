/**
 * This function generate an email for an invitation to a classroom.
 */
...
export type GenerateInvitationToClassroomMailProps = {
  sender: {
    first_name: string;
    last_name: string;
    email: string;
...
export function GenerateInvitationToClassroomMail({
  sender,
  link,
  classroomName,
}: GenerateInvitationToClassroomMailProps) {
  const html = `
      ...
      <tr>
        ...
        <td align="center" data-bgcolor="Body" bgcolor="#F4F4F4" data-composer>
          <table
            ...
            data-module="colibri-preheader-6"
          >
            <!-- colibri-preheader-6 -->
            <tr>
              <td align="center" bgcolor="#cdd0e3" data-bgcolor="BgColor">
                <!-- Content -->
                <table
                  data-inner-table
                  border="0"
                ...
                >
                  ...
                  <tr data-element="colibri-preheader-6-logo" data-label="Logo">
                    <td
                      height="30"
                    ...
                    <div>
                      ...
                      >
                        <tr>
                          <td
                            align="center"
                            background="images/header-6-back.png"
                            data-bg-image
          ...
          <table
            ...
            width="640"
            style="width: 640px; max-width: 640px"
            data-module="colibri-basic-message-6"
          >
            <!-- colibri-basic-message-6 -->
            <tr>
              <td align="center" bgcolor="#cdd0e3" data-bgcolor="BgColor">
                <!-- Content -->
                <table
                    ...
                    >
                      <singleline>
                        <div mc:edit data-text-edit>
                          Poslana ti je pozivnica za učionicu!
                        </div>
                      </singleline>
                    </td>
                  </tr>
                      ...
                      >
                        <tr>
                          ...
                          >
                            <singleline>
                              <div mc:edit data-text-edit>
                                Bok! ${sender.first_name}
                                ${sender.last_name} ti je upravo poslao
                                pozivnicu za pridruživanje u učionicu
                                "${classroomName}". Klikni na gumb ispod da vidiš
                                više informacija.
                                <hr />
                                <p style="color: red">
                                  NE prihvaćajte pozive od osoba koje ne znate!
                                </p>
                              </div>
                            </singleline>
                          </td>
